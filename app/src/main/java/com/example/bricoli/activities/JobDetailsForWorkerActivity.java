...
public class JobDetailsForWorkerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Worker worker = new Worker(1L,"cin","pass","30/40,Marakech",10L,1,"ggg","fullName","ggggg","666666","");
        Client client = new Client(1L,"cin","zzzzz","30/40,Marakech",2L,2,"dfghj","name","gghhhhh","3456788","");
